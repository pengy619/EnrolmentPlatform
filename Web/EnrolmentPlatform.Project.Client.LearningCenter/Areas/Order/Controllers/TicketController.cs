...
namespace EnrolmentPlatform.Project.Client.LearningCenter.Areas.Order.Controllers
{
    public class TicketController : BaseController
    {
        ...
        {
            string s = JsonConvert.SerializeObject(new SaveTicketOrderDTO());
            return View();
        }
        /// <summary>
        /// 订单列表异步搜索
        ...
        public async Task<string> Search(TicketOrderSearchParamDTO param)
        {
            ...
            var msg = await WebApiHelper.PostAsync<HttpResponseMsg>("/api/OrderForTicket/SupplierGetTicketOrderList", JsonConvert.SerializeObject(param), ConfigurationManager.AppSettings["StaffId"].ToInt());
        ...
        public async Task<ActionResult> Detail(Guid id)
        {
            ...
            var msg = await WebApiHelper.GetAsync<HttpResponseMsg>("/api/OrderForTicket/SupplierGetTicketOrderByOrderId", parameters.Item1, parameters.Item2, ConfigurationManager.AppSettings["StaffId"].ToInt());
            if (msg.IsSuccess)
            {
        ...
        {
            param.SupplierId = base.SupplierId;
            var msg = await WebApiHelper.PostAsync<HttpResponseMsg>("/api/VerificationForTicket/SupplierGetTicketVerificationList", JsonConvert.SerializeObject(param), ConfigurationManager.AppSettings["StaffId"].ToInt());
            return msg.Data.ToString();
        }
        ...
        public async Task<JsonResult> SupplierUpdatePrice(UpdateSpecialtyOrderPriceDTO dto)
        {
            ...
            var msg = await WebApiHelper.PostAsync<HttpResponseMsg>("/api/OrderForTicket/SupplierUpdatePrice", JsonConvert.SerializeObject(dto), ConfigurationManager.AppSettings["StaffId"].ToInt());
            return Json(msg);
        }
        /// <summary>
        /// 供应商申请退款
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<JsonResult> SupplierRefund(SupplierTicketOrderRefundDTO dto)
        {
            dto.SupplierId = base.SupplierId;
            dto.UpdateUserId = base.UserId;
            dto.UpdateUserName = base.UserAccount;
            var msg = await WebApiHelper.PostAsync<HttpResponseMsg>("/api/OrderForTicket/SupplierRefund", JsonConvert.SerializeObject(dto), ConfigurationManager.AppSettings["StaffId"].ToInt());
            return Json(msg);
        }
        /// <summary>
        /// 供应商处理C端用户的取消
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<JsonResult> SupplierHandleRefund(SupplierTicketOrderHandleRefundDTO dto)
        {
            dto.SupplierId = base.SupplierId;
            dto.UpdateUserId = base.UserId;
            dto.UpdateUserName = base.UserAccount;
            var msg = await WebApiHelper.PostAsync<HttpResponseMsg>("/api/OrderForTicket/SupplierHandleRefund", JsonConvert.SerializeObject(dto), ConfigurationManager.AppSettings["StaffId"].ToInt());
            return Json(msg);
        }
        /// <summary>
        /// 供应商主动取消
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<JsonResult> SupplierCancel(SupplierTicketOrderHandleRefundDTO dto)
        {
            dto.SupplierId = base.SupplierId;
            dto.UpdateUserId = base.UserId;
            dto.UpdateUserName = base.UserAccount;
            var msg = await WebApiHelper.PostAsync<HttpResponseMsg>("/api/OrderForTicket/SupplierCancel", JsonConvert.SerializeObject(dto), ConfigurationManager.AppSettings["StaffId"].ToInt());
            return Json(msg);
        }
        #endregion
        /// <summary>
        ...
        private HSSFWorkbook GetWorkbook(List<TicketOrderInfo> list)
        {
            ...
            //新建数组保存标题
            string[] s_strTitle = { "订单编号", "产品名称", "出行日期", "购买数量", "订单总金额", "订单状态", "出票状态", "下单时间", "订单来源", "下单账户" };
            //加载标题行
