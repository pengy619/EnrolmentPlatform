...
layui.config({
    base: '/Content/Website/cropper/' //layui自定义layui组件目录,根据自己具体项目结构而定
    ...
    var obj = {
        ...
        render: function (e) {
            var self = this,
                ...
                saveH = e.saveH,
                mark = e.mark,
                size = e.size == undefined ? 10240 : e.size,
                area = e.area,
                url = e.url,
                done = e.done;
            ...
            // 注意更改这里css的路径
            var cropperHtml = '<link rel="stylesheet" href="/Content/Website/cropper/cropper.css">\n' +
