...
namespace EnrolmentPlatform.Project.Client.Admin.Filter
{
    ...
    public class LoginInfoHandle
    {
        ...
        /// 登陆cookie
        /// </summary>
        public static string LoginCookieName = "AdminUserInfo";
        ...
        public static List<RolePermissionDto> NoCheckPermission = new List<RolePermissionDto>()
        {
            ...
            //添加权限后门
             new RolePermissionDto(){ Area="", Controller="home",Action= "DistributionPermissions" },
             new RolePermissionDto(){ Area="", Controller="home",Action= "GetSystemPermissionList" },
             new RolePermissionDto(){ Area="", Controller="home",Action= "DeletePermission" },
             new RolePermissionDto(){ Area="", Controller="home",Action= "GetPermission" },
        };
        ...
        public static List<RolePermissionDto> GetAllPermissionList()
        {
            ...
            "/api/Role/GetAllPermissionList", "", "systemTypeEnum=" + (int)SystemTypeEnum.ChannelCenter,
        ...
        public static List<RolePermissionDto> GetUserPermissions()
        {
            ...
            //系统权限树权限（该权限包含操作权限）
            var data = WebApiHelper.Get<HttpResponseMsg>(
            "/api/Role/GetRolePermissionList", "", "roleId=" + user.RoleId.ToString() + "&systemTypeEnum=" + (int)SystemTypeEnum.ChannelCenter,
            ConfigurationManager.AppSettings["StaffId"].ToInt());
