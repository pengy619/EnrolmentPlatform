...
GO
/****** Object:  Table [dbo].[T_AccountDetailInfo]    Script Date: 2018/11/24 20:04:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[T_AccountDetailInfo](
	[Id] [uniqueidentifier] NOT NULL,
	[EnterpriseId] [uniqueidentifier] NOT NULL,
	[Amount] [decimal](18, 2) NOT NULL,
	[TransactionClassify] [int] NOT NULL,
	[TranscationNo] [nvarchar](max) NULL,
	[TranscationBeforeAmount] [decimal](18, 2) NOT NULL,
	[TranscationAfterAmount] [decimal](18, 2) NOT NULL,
	...
	[Unix] [bigint] NOT NULL,
	[RowVersion] [timestamp] NOT NULL,
 CONSTRAINT [PK_dbo.T_AccountDetailInfo] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[T_DeliveryAddress]    Script Date: 2018/11/24 20:04:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[T_DeliveryAddress](
	[Id] [uniqueidentifier] NOT NULL,
	[AccountId] [uniqueidentifier] NOT NULL,
	[Consignee] [nvarchar](200) NULL,
	[ContactPhone] [nvarchar](200) NULL,
	[Address] [nvarchar](200) NULL,
	[FullAddressName] [nvarchar](200) NULL,
	[AddressId] [uniqueidentifier] NULL,
	[IsDefault] [bit] NULL,
	[IsDelete] [bit] NOT NULL,
	[CreatorTime] [datetime] NOT NULL,
	...
	[Unix] [bigint] NOT NULL,
	[RowVersion] [timestamp] NOT NULL,
 CONSTRAINT [PK_dbo.T_DeliveryAddress] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
...
GO
/****** Object:  Table [dbo].[T_OrderSettlement]    Script Date: 2018/11/24 20:04:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[T_OrderSettlement](
	[Id] [uniqueidentifier] NOT NULL,
	[EnterpriseId] [uniqueidentifier] NOT NULL,
	[SettlementNo] [nvarchar](max) NULL,
	...
	[Unix] [bigint] NOT NULL,
	[RowVersion] [timestamp] NOT NULL,
 CONSTRAINT [PK_dbo.T_OrderSettlement] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
...
GO
/****** Object:  Table [dbo].[T_OrderSettlementInfo]    Script Date: 2018/11/24 20:04:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[T_OrderSettlementInfo](
	[Id] [uniqueidentifier] NOT NULL,
	[EnterpriseId] [uniqueidentifier] NOT NULL,
	[SettlementNo] [nvarchar](max) NULL,
	[OrderClassify] [int] NOT NULL,
	[OrderNo] [nvarchar](max) NULL,
	[OrderName] [nvarchar](max) NULL,
	[SettlementAmount] [decimal](18, 2) NOT NULL,
	[OrderAmount] [decimal](18, 2) NOT NULL,
	[SettlementCycle] [nvarchar](max) NULL,
	[Status] [int] NOT NULL,
	...
	[Unix] [bigint] NOT NULL,
	[RowVersion] [timestamp] NOT NULL,
 CONSTRAINT [PK_dbo.T_OrderSettlementInfo] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
...
GO
/****** Object:  StoredProcedure [dbo].[P_CopyProduct]    Script Date: 2018/11/24 20:04:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[P_GetHomeInfoForAdmin]    Script Date: 2018/11/24 20:04:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[P_GetHomeInfoForAdminByTime]    Script Date: 2018/11/24 20:04:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[P_GetHomeInfoForSupplierByTime]    Script Date: 2018/11/24 20:04:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[P_GetHomeInfoForSupplierId]    Script Date: 2018/11/24 20:04:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[P_GetTicketByScenicOrPlayForB2C]    Script Date: 2018/11/24 20:04:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[P_GetTicketByScenicOrPlayForH5]    Script Date: 2018/11/24 20:04:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[P_UpdateMinPriceForProduct]    Script Date: 2018/11/24 20:04:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
