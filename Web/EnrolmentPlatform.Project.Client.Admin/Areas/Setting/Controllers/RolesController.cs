...
namespace EnrolmentPlatform.Project.Client.Admin.Areas.Setting.Controllers
{
    public class RolesController : BaseController
    {
        ...
        public ActionResult Option(Guid? roleId)
        {
            ...
            "/api/Role/GetAllPermissionList", "", "systemTypeEnum=" + ((int)SystemTypeEnum.ChannelCenter).ToString(),
        ...
        public async Task<string> Search(RoleSearchDto param)
        {
            ...
            param.SystemType = EnrolmentPlatform.Project.DTO.Enums.Systems.SystemTypeEnum.ChannelCenter;
        ...
        public JsonResult SaveRole(RoleDto dto)
        {
            ...
            dto.SystemType = EnrolmentPlatform.Project.DTO.Enums.Systems.SystemTypeEnum.ChannelCenter;
